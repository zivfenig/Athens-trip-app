...
<div id="app">
  ...
  <div class="top-bar">
    ...
    <div class="top-bar-right">
      <button id="keyStatusBtn" class="key-status-btn" onclick="showKeyModal()">🔑 Token</button>
  ...
  <div id="pageSummary" class="page active">
    <div class="trip-hero">
      ...
      <div class="trip-stats">
        <div class="trip-stat"><div class="trip-stat-num" id="statItinerary">0</div><div class="trip-stat-label">במסלול</div></div>
        <div class="trip-stat"><div class="trip-stat-num" id="statAttr">0</div><div class="trip-stat-label">אטרקציות</div></div>
        <div class="trip-stat"><div class="trip-stat-num" id="statExpenses">0</div><div class="trip-stat-label">הוצאות</div></div>
      </div>
    </div>
    <div class="expense-summary">
      <div class="expense-summary-title">📊 סיכום הוצאות</div>
  ...
  <div id="pageItinerary" class="page">
    <div class="page-header">📅 מסלול הטיול</div>
    <div class="page-subheader">בחרו פריטים מאטרקציות, מסעדות וקניות</div>
    <div class="day-tabs" id="dayTabs"></div>
    <button class="optimize-btn" id="itinOptBtn" onclick="optimizeItineraryDay()" style="display:none">
      🧭 סדר חכם לפי מיקום
    </button>
  ...
  <!-- ══ PAGE: אטרקציות ═══════════════════════════════════════ -->
  <div id="pageAttractions" class="page">
    <div class="page-header">🏛️ אטרקציות</div>
    <div class="page-subheader">מקומות שווה לבקר בהם</div>
    <div class="rest-toolbar">
      <div class="rest-cat-filter" id="attractionsCatFilter"></div>
      <button class="proximity-btn" id="attractionsProxBtn" onclick="sortByProximity('attractions')">📍 דרג לפי קרבה</button>
    </div>
    <div id="attractionsList"></div>
    <div id="attractionsAdminAdd" style="display:none;margin-top:8px">
      <button class="add-btn" onclick="openAddItem('attractions')">➕ הוסף אטרקציה</button>
    </div>
  </div>
  ...
  <div id="pageRestaurants" class="page">
    ...
    <div class="page-subheader">מסעדות שווה לנסות</div>
    <div class="rest-toolbar">
      <div class="rest-cat-filter" id="restaurantsCatFilter"></div>
      <button class="proximity-btn" id="restaurantsProxBtn" onclick="sortByProximity('restaurants')">📍 דרג לפי קרבה</button>
    </div>
    <div id="restaurantsList"></div>
    <div id="restaurantsAdminAdd" style="display:none;margin-top:8px">
      <button class="add-btn" onclick="openAddItem('restaurants')">➕ הוסף מסעדה</button>
    </div>
  </div>

  <!-- ══ PAGE: קניות ══════════════════════════════════════════ -->
  <div id="pageShopping" class="page">
    <div class="page-header">🛍️ קניות</div>
    <div class="page-subheader">שווקים וחנויות מומלצות</div>
    <div class="rest-toolbar">
      <div class="rest-cat-filter" id="shoppingCatFilter"></div>
      <button class="proximity-btn" id="shoppingProxBtn" onclick="sortByProximity('shopping')">📍 דרג לפי קרבה</button>
    </div>
    <div id="shoppingList"></div>
    <div id="shoppingAdminAdd" style="display:none;margin-top:8px">
      <button class="add-btn" onclick="openAddItem('shopping')">➕ הוסף מקום קנייה</button>
    </div>
  </div>
  ...
  <div id="pageExpenses" class="page">
    ...
    <div class="expense-form-card">
      ...
      <div class="cat-chips" id="expCatChips">
        <div class="cat-chip active" data-cat="shopping" onclick="selectExpCat(this)" style="background:#9b72f0;border-color:#9b72f0;color:white">🛍️ שופינג</div>
        <div class="cat-chip" data-cat="food"      onclick="selectExpCat(this)">🍽️ אוכל</div>
        <div class="cat-chip" data-cat="transport" onclick="selectExpCat(this)">🚌 תחבורה</div>
        <div class="cat-chip" data-cat="other"     onclick="selectExpCat(this)">📦 אחר</div>
      </div>
  ...
  <div id="pageMap" class="page" style="padding-bottom:80px">
    ...
    <div id="mapContainer">
      <iframe src="https://maps.google.com/maps?q=Faliro+8+Athens+Greece&output=embed&z=14&hl=iw" allowfullscreen loading="lazy"></iframe>
    </div>
  </div>
  ...
  <div id="pageChat" class="page">
    <div class="chat-wrapper">
      <div class="chat-header">
        ...
        <button class="chat-clear-btn" onclick="clearChat()">🗑️ נקה</button>
      </div>
      <div class="chat-messages" id="chatMessages"></div>
      <div>
        <div class="chat-input-row">
          <textarea class="chat-input" id="chatInput" placeholder="שאלו אותי על יוון..." rows="1"></textarea>
  ...
  <nav class="bottom-nav">
    ...
    <button class="nav-item" onclick="showPage('itinerary',this)">
      <span class="nav-icon">📅</span><span class="nav-label">מסלול</span>
    </button>
    <button class="nav-item" onclick="showPage('attractions',this)">
      <span class="nav-icon">🏛️</span><span class="nav-label">אטרקציות</span>
    </button>
    <button class="nav-item" onclick="showPage('restaurants',this)">
      <span class="nav-icon">🍽️</span><span class="nav-label">מסעדות</span>
    </button>
    <button class="nav-item" onclick="showPage('shopping',this)">
      <span class="nav-icon">🛍️</span><span class="nav-label">קניות</span>
    </button>
    <button class="nav-item" onclick="showPage('expenses',this)">
      <span class="nav-icon">💰</span><span class="nav-label">הוצאות</span>
    </button>
